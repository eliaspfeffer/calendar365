    ...
    <div className="space-y-10">
      ...
      <section className="space-y-3">
        ...
        <div className="space-y-3 text-sm text-muted-foreground">
          ...
          <div>
            ...
            <p className="mt-1">
              If you create an account or sign in, your authentication data (such as email address and session tokens) is
              processed to provide login and session management. Session information may be stored in your browser (for
              example in local storage) to keep you signed in.
            </p>
          </div>
          <div>
      ...
      <section className="space-y-2">
        ...
        <p className="text-sm text-muted-foreground">
          ...
          providers) may process data on our behalf as processors. If you self-host, you are responsible for choosing and
          documenting your processors.
        </p>
      </section>
