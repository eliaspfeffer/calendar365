  ...
  return (
    <main className="min-h-screen bg-background">
      <div className="mx-auto max-w-3xl px-6 py-12">
        ...
        <p className="mt-2 text-sm text-muted-foreground">Information pursuant to § 5 DDG (Germany).</p>
        ...
        <section className="mt-10 space-y-4">
          ...
          <div className="space-y-3 text-sm">
            ...
            <div>
              ...
              <p className="mt-1 text-muted-foreground">
                Our website may contain links to external websites. We have no influence over the content of those
                websites and therefore cannot assume any liability for their content. The respective provider or operator
